...
- 欢迎使用官方通道：[在线上传文件打标 →](https://skin.gushao.club/docs/extra_service/UploadHandWeb)
- 欢迎使用备用通道：[在线上传文件打标 Mirror →](http://skin.gushao.club/docs/extra_service/UploadHandWebMirror/)
